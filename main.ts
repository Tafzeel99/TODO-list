...
// Make a Array & Conditional Variable
...
let main = async () => {
    while(while_Condition){
        ...
        // Calling appropriate functions based on user choice
            ...
            // Confirmation from user to exit or not.
...
let add_function = async () => {
    ...
    // If user didn't write anything dont add it!
    if (addTask.task !== "") {
